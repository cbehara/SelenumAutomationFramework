...
public class SecurityAccessorsPage extends TestBase {
	...
	public String gettextofSecurityAccessors()
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_verifySecurityAccessors, 30);
	...
	public void addSecurityAccessors( String Description,String KeyType,String KeyPurpose)
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_AddSecurityAccessorsName, 30);
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_SecurityAccessorsDescription, 30);
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_KeyTypeDropDown, 30);
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_KeyPurposeDropDown, 30);
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_IsWrapperCheckbox, 30);
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_AddSecurityAccessorButton, 30);
	...
	public void changePreviliegesSecurityAccessors()
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_ChangePrivileges, 50);
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_ViewPrivilagesCheckbox, 30);
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_SaveSecurityAccessor, 30);
	...
	public void editedSecurityAccessors(String UpdatedKeyPurpose )
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_EditSecurityAccessor, 30);
	...
	public void removeSecurityAccessors()
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_SecurityAccessorRemove, 30);
	...
	public String gettextofaddSecurityAccessors()
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_verifytextaddedSecurityAccessor, 30);
	...
	public String gettextofSaveSecurityAccessors()
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_verifytextSecurityAccessorSaved, 30);
	...
	public String gettextofRemoveSecurityAccessors()
	{
		...
		TestUtil.waitforElementTobeLocated(ConxoMultisense_SecAccessorsPage_verifytextremovedSecurityAccessor, 30);

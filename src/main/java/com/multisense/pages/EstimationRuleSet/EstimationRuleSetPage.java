...
//		TestUtil.waitforElementTobeLocated(ConnexoMultisense_EstmnRulesetPage_Actions, 20);
//		doClick(ConnexoMultisense_EstmnRulesetPage_Actions);
//		
...
//		
//		WebElement a= DriverUtility.getDriver().findElement(By.xpath("//*[text()='"+ Estimationrule +"']//ancestor::td//following-sibling::td//span")); 
//		doClick(a);
////		WebElement ConnexoMultisense_EstmnRulesetPage_Actions = DriverUtility.getDriver().findElement(By.xpath(prop.getProperty("ConnexoMultisense_EstmnRulesetPage_Actions")));
//		ConnexoMultisense_EstmnRulesetPage_Actions.click();
//		DriverUtility.getDriver().findElement(By.xpath("//span[text()='Deactivate']")).click();
//		DriverUtility.getDriver().findElement(By.xpath("(//span[contains(@class,'x-btn-icon-el icon')])[5]")).click();
////		DriverUtility.getDriver().findElement(By.xpath("//div[contains(@class,'x-component x-header-text-container')]/following-sibling::a[1]")).click();
//		WebElement ConnexoMultisense_EstmnRulesetPage_Actions_editbutton = DriverUtility.getDriver().findElement(By.xpath(prop.getProperty("ConnexoMultisense_EstmnRulesetPage_Actions_editbutton")));
//		ConnexoMultisense_EstmnRulesetPage_Actions_editbutton.click();
//		DriverUtility.getDriver().manage().timeouts().implicitlyWait(Duration.ofSeconds(150));
//		Thread.sleep(3000);

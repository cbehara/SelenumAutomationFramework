...
public class DeviceLifeCycleManagementAddDeviceTest extends TestBase {
	...
	@Test(priority =17, enabled = true, description = "Verify Validation Configuartion in Reading Quality Page")
	...
	@Test(priority =18, enabled = true, description = "Verify ValidationConfiguartion Deactivation and active actions")

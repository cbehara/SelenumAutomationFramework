...
public class RegisterTypeTest  extends TestBase{
	...
	public void removeRegistertype(String obiscode, String readingtype, String Updateobiscode ) throws InterruptedException
	{ 
		reporterLog("Starting Testcase Remove Register Type name");
		log.info("****************************** starting testcase : Remove RegisterType Name***************************");
		RegisterTypepage.removeRegistrtype(readingtype);

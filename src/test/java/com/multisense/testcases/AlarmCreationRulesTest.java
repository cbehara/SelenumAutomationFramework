...
public class AlarmCreationRulesTest extends TestBase {
	...
	public void editalarmcreationrule(String templateName, String raisedOrCleared, String isEventTypePartsSpecified, String eventType, String deviceType, String deviceDomain, String deviceSubDomain, String deviceEventOrAction, String deviceCode, String removeEventTypes, String deviceGroups, String deviceTypes, String deviceStates, String logOnExistingOpenAlarms, String increaseUrgencyWhenRaised, String decreaseUrgencyWhenCleared, String numberofEvents, String eventsPerTime, String urgency, String impact, String dueInDays, String dueInPeriod, String alarmReason, String comment) throws InterruptedException
	{	
		reporterLog("Editing Alarm Creation rules");
		log.info(" Editing Alarm Creation rules ");		
		addEditAlarmCreationRulePage.editActivateAlarmCreationRules(name);
		log.info("Clicked on Edit button and navigating to Edit Alarm Creation rule page");
		addEditAlarmCreationRulePage.addName(editname);
		log.info("Entered Name : " + editname + " in Alarm Creation rule page");
		waitForTime(500);
		scrolltobottom();		
		
		addEditAlarmCreationRulePage.selectRuleTemplate(templateName);
		log.info("Entered Name : " + name + " in Alarm Creation rule page");
		waitForTime(500);
		addEditAlarmCreationRulePage.selectRuleTemplate(templateName);
		log.info("Selected Rule template : "+ templateName + " in Alarm Creation rule page");
		waitForTime(500);		
		...
		alarmCreationRulesPage = addEditAlarmCreationRulePage.clickOnSaveButton();		 
	    log.info("Clicked on the button: Add Action");
		String ExpetedAlarmCreationRuleEditMsg = "Alarm creation rule Edited";
        WebElement ActualAlarmCreationRuleEditMsg = addEditAlarmCreationRulePage.txtDeActivateAlarmRuleCreation;
        SoftAssertfunction(ActualAlarmCreationRuleEditMsg, ExpetedAlarmCreationRuleEditMsg);
                        
        log.info("****************************** Ending Test Case : Verification of Alarm rule Editing*****************************************");
	}
	*/

	@Test(priority = 6, enabled = true, description ="Verify Alarms rule removal")
